...
<form method="get" action="<?php echo WP_Job_Board_Mixes::get_jobs_page_url(); ?>" class="filter-job-form filter-listing-form">
	<?php $fields = WP_Job_Board_Job_Filter::get_fields(); ?>

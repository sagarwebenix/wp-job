...
<form method="get" action="<?php echo WP_Job_Board_Mixes::get_employers_page_url(); ?>" class="filter-employer-form filter-listing-form">
	
	<?php $fields = WP_Job_Board_Employer_Filter::get_fields(); ?>

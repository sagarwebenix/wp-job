...
<div class="jobs-ordering-wrapper">
	<form class="jobs-ordering" method="get" action="<?php echo WP_Job_Board_Mixes::get_jobs_page_url(); ?>">
		<div class="label"><?php esc_html_e('Sort by:', 'wp-job-board'); ?></div>
		<select name="filter-orderby" class="orderby" data-placeholder="<?php esc_attr_e('Sort by', 'wp-job-board'); ?>">

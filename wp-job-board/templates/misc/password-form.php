...
<form method="post" action="" class="change-password-form">
	<div class="form-group">
		<label for="change-password-form-old-password"><?php echo __( 'Old password', 'wp-job-board' ); ?></label>
		<input id="change-password-form-old-password" class="form-control" type="password" name="old_password" required="required">
	</div><!-- /.form-control -->

	<div class="form-group">
		<label for="change-password-form-new-password"><?php echo __( 'New password', 'wp-job-board' ); ?></label>
	...
	<div class="form-group">
		<label for="change-password-form-retype-password"><?php echo __( 'Retype password', 'wp-job-board' ); ?></label>
	...
	<button type="submit" name="change_password_form" class="button"><?php echo __( 'Change Password', 'wp-job-board' ); ?></button>
</form>

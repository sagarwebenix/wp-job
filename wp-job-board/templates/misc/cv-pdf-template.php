<?php
	...
	$styles = apply_filters( 'wp-job-board-create-resume-pdf-styles', array() );
	if ( !empty($styles) ) {
	...
	$pdf_output .= '
		...
		<body xml:lang="en">
			...
			<div id="content" class="widecolumn">';
				...
				$pdf_output .= WP_Job_Board_Template_Loader::get_template_part( 'content-single-candidate-pdf' );
			// post finish

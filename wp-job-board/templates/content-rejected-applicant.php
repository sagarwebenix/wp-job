    ...
    <div class="applicant-information">
        ...
        <div class="applicant-action-button">
            ...
            <div class="all-actions-wrapper">
                ...
                <a href="javascript:void(0);" class="btn-undo-reject-job-applied" data-applicant_id="<?php echo esc_attr($post->ID); ?>" data-nonce="<?php echo esc_attr(wp_create_nonce( 'wp-job-board-undo-reject-applied-nonce' )); ?>"><?php esc_html_e('Undo Rejected', 'wp-job-board'); ?></a>

...
class WP_Job_Board_Indeed_API {
    ...
    public static function indeed_api_countries() {
        ...
        return apply_filters( 'wp-job-board-indeed-api-countries', $countries );
    }
    ...
    public static function indeed_job_types() {
        ...
        return apply_filters( 'wp-job-board-indeed-job-types', $types );
    }
    ...
    public static function get_default_args() {
        ...
        if (!empty($_SERVER['HTTP_CLIENT_IP'])) {
            $args['userip'] = $_SERVER['HTTP_CLIENT_IP'];
        } elseif (!empty($_SERVER['HTTP_X_FORWARDED_FOR'])) {
            $args['userip'] = $_SERVER['HTTP_X_FORWARDED_FOR'];
        } else {

...
class WP_Job_Board_Taxonomy_Job_Tag{
	...
	public static function definition() {
		...
		$rewrite_slug = get_option('wp_job_board_job_tag_slug');
		if ( empty($rewrite_slug) ) {
			$rewrite_slug = _x( 'job-tag', 'Job tag slug - resave permalinks after changing this', 'wp-job-board' );
		}
		$rewrite = array(
			'slug'         => $rewrite_slug,
			'with_front'   => false,
...
WP_Job_Board_Taxonomy_Job_Tag::init();
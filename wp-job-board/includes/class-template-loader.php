...
class WP_Job_Board_Template_Loader {
	 ...
	 * @throws Exception
	 */
	public static function locate( $name, $plugin_dir = WP_JOB_BOARD_PLUGIN_DIR ) {
		$template = '';

		$theme_folder_name = apply_filters( 'wp-job-board-theme-folder-name', 'wp-job-board' );
	 ...
	 * @throws Exception
	 */
	public static function get_template_part( $name, $args = array(), $plugin_dir = WP_JOB_BOARD_PLUGIN_DIR ) {
...
WP_Job_Board_Template_Loader::init();
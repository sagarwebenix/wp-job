...
class WP_Job_Board_CMB2_Field_Image_Select {

	public static function init() {
		add_filter( 'cmb2_render_wp_job_board_image_select', array( __CLASS__, 'render_map' ), 10, 5 );
		add_filter( 'cmb2_sanitize_wp_job_board_image_select', array( __CLASS__, 'sanitize_map' ), 10, 4 );	
	}
...
WP_Job_Board_CMB2_Field_Image_Select::init();